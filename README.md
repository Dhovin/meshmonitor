...
- **Multi-Protocol, Multi-Source** - Monitor Meshtastic (TCP/Serial/BLE), [MeshCore](docs/features/meshcore.md) ([Setup Guide](docs/configuration/meshcore-node.md)), and MQTT brokers from a single deployment, with per-source permissions, schedulers, and Virtual Nodes
